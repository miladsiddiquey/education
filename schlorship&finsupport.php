...
<html lang="en">
  <head>
    ...
    <title>Schlorship & Financial Support</title>
  ...
  <body>
        ...
        <div class="simple-grid-content grid-2">
          ...
          <div class="simple-grid-content-text">
            ...
            <p class="">
              ...
              biggest challenge they face is the cost involved. A scholarship
              can enable them to fulfill their aspiration, but, unfortunately,
              many aren't aware of the process and the steps involved to apply
              for a scholarship. Rather, there's a general misconception that
              there is no such scholarship for international students.
              Apparently, there are several universities and colleges abroad
              that provide scholarships to International Student in order to
              attract the best and the brightest minds.
            </p>
    ...
    <div class="home-faq mt-5" style="background: var(--white)">
      <div class="container">
      ...
      <div class="container">
        ...
        <div class="uni-table-box">
          ...
          <ul class="uni-table-box-body">
            ...
            <li>UG Level</li>
            <li>
              CAD 5,000 (75%-80%), CAD 7,500 (81%-89%), CAD 10000 (90% or above)
            </li>
            <li>2023</li>
          </ul>
        </div>
    ...
    <div class="sample-text">
      <div class="container">
        <div class="sample-text-box">
          <h3>Check your Eligibility for Specific Scholarships</h3>
          <p>
