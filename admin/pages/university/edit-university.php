...
if (isset($_POST['submit'])) {
    ...
    $obj->update('top_university', $update_data, "id=$id");
    $result = $obj->getResult();
      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" action="edit-university.php?id=<?php echo $row['id']; ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="d-flex justify-content-between">
                <div class="form-group">
                  ...
                  <input type="text" name="global_ranking" value="<?php echo $row['global_ranking']; ?>" class="form-control" id="exampleInputName1" placeholder="Number">
                </div>
                <div class="form-group">
                  <label for="exampleInputName1">University</label>
                  <input type="text" name="university_name" value="<?php echo $row['university_name']; ?>" class="form-control" id="exampleInputName1" placeholder="University Name">
                </div>
                <div class="form-group">
                  <label for="exampleInputName1">No. of Students</label>
                  <input type="text" name="student_no" value="<?php echo $row['student_no']; ?>" class="form-control" id="exampleInputName1" placeholder="Number">
                </div>
                <div class="form-group">
                  <label for="exampleInputName1">No. of Courses</label>
                  <input type="text" name="courses_no" value="<?php echo $row['courses_no']; ?>" class="form-control" id="exampleInputName1" placeholder="Number">
                </div>
              </div>
              <div class="form-group">
