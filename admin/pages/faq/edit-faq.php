    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <ul class="nav">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link"
                                    href="../../pages/ui-features/buttons.php">Buttons</a></li>
                            <li class="nav-item"> <a class="nav-link"
                                    href="../../pages/ui-features/dropdowns.php">Dropdowns</a></li>
                            <li class="nav-item"> <a class="nav-link"
                                    href="../../pages/ui-features/typography.php">Typography</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item menu-items">
                ...
                <!-- Destination post -->
                <li class="nav-item menu-items">
                    <a class="nav-link" data-toggle="collapse" href="#des_post" aria-expanded="false"
                        aria-controls="ui-basic">
                        <span class="menu-icon">
                            <i class="mdi mdi-laptop"></i>
                        </span>
                    ...
                    <div class="collapse" id="des_post">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="add-destination.php">Add Destination</a>
                            </li>
                            <li class="nav-item"> <a class="nav-link" href="list-destination.php">List Destination</a>
                            </li>
                        </ul>
                    </div>
                </li>
              ...
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item menu-items">
                    ...
                    <div class="collapse" id="auth">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="../../pages/samples/blank-page.php"> Blank
                                    Page </a></li>
                            <li class="nav-item"> <a class="nav-link" href="../../pages/samples/error-404.php"> 404 </a>
                            </li>
                            <li class="nav-item"> <a class="nav-link" href="../../pages/samples/error-500.php"> 500 </a>
                            </li>
                            <li class="nav-item"> <a class="nav-link" href="../../pages/samples/login.php"> Login </a>
                            </li>
                            <li class="nav-item"> <a class="nav-link" href="../../pages/samples/register.php"> Register
                                </a></li>
                        </ul>
                    </div>
                </li>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="question"  class="form-control" id="exampleInputName1" placeholder="Question" value="<?php echo $row['question'] ?>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Answer</label>
                        <textarea type="text" name="answer" class="form-control" id="exampleInputEmail3" rows="3" value="<?php echo $row['answer'] ?>" ></textarea>
                      </div>
...
if(isset($_POST['update-btn'])){
  include "../../config.php";
  $question =mysqli_real_escape_string($con, $_POST['name']);
  $answer =mysqli_real_escape_string($con, $_POST['description']);
  ...
  alert("data Update successfully");
   window.open(
    'http://localhost/education/admin/pages/review/list-review.php','_self');
  </script>
<?php
}else{
    ?>
