...
<html lang="en">
  ...
  <body>
    ...
    <div class="student-essensial">
      <div class="container">
        <div class="section-header">
          <h2>Student Essentials</h2>
        </div>

        <div class="student-essensial-content grid-2">
          <div class="student-essensial-box">
            <div class="student-icon">
              <i class="fa-solid fa-shield-halved"></i>
            </div>
            <h3>Get the right student health cover</h3>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Diam
              maecenas ultricies mi eget mauris pharetra et. Nulla aliquet
              porttitor lacus luctus accumsan tortor. Platea dictumst quisque
