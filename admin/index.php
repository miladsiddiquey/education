        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="des_post">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="./pages/destination/list-destination.php">List Destination</a></li>
              </ul>
            </div>
          </li>
          <!-- Team Members -->
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="team-member">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="./pages/team/add-team.php">Add Members</a></li>
                <li class="nav-item"> <a class="nav-link" href="./pages/team/list-team.php">List Members</a></li>
              </ul>
            </div>
          </li>
          <!-- client review  -->
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="college">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="./pages/allcolleges/add-col.php">Add colleges</a></li>
                <li class="nav-item"> <a class="nav-link" href="./pages/allcolleges/list-col.php">List colleges</a></li>
              </ul>
            </div>
          </li>
          <!-- faq  -->
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="./pages/users/add-user.php">Add user</a></li>
                <li class="nav-item"> <a class="nav-link" href="./pages/users/list-user.php">List user</a></li>
              </ul>
            </div>
          </li>
          <!-- <li class="nav-item menu-items">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="faces/face15.jpg" alt="">
