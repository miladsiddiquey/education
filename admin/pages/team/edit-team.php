                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- post form -->
                                    <form class="forms-sample" action="edit-team.php?id=<?php echo $row['id'] ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="description" class="form-control"
                                                id="exampleInputEmail3" value="<?php echo $row['description'] ?>">
                                        </div>
                                        <div class="form-group">
...
if(isset($_POST['update-btn'])){
  ...
  $sql = "UPDATE team SET name = '$t_name', description = '$des', image = '$update_filename' WHERE id = '$id' ";
  ...
  if($result){
    ...
    ?>
                                    ...
                                    window.open(
                                        'http://localhost/education/admin/pages/team/list-team.php',
                                        '_self');
                                    </script>
                                    <?php
}else{
