                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- post form -->
                                    <form class="forms-sample" action="edit-review.php?id=<?php echo $row['id'] ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="stars"  maxlength="1" class="form-control" id="exampleInputName1"value="<?php echo $row['stars'] ?>" placeholder="Stars">
                                        </div>
                                        <div class="form-group">
