...
<html lang="en">
  <head>
    ...
    <title>Student Health Cover</title>
        ...
        <div class="simple-grid-content grid-2">
          ...
          <div class="simple-grid-content-text">
            <h3 style="font-size: var(--big-font)">
              Get the Right Student Health Cover While Studying in Canada
            </h3>
            <p class="mb-3">
              Congratulations! You’ve made a great decision to study abroad.
              We’re here to make the process easy, finding the best cover to
              suit your needs.
            </p>
            <h4 class="text-dark">Why do I need a student health cover?</h4>
            <p>
              It helps cover you for medical expenses while you're studying
              abroad, including:
            </p>
            <ul class="row list-red mb-2">
              <li class="col-6">Doctor visits</li>
              <li class="col-6">Doctor visits</li>
              <li class="col-6">Doctor visits</li>
              <li class="col-6">Doctor visits</li>
            </ul>
            <p>
              For some countries, you will need health insurance before you can
    ...
    <div class="simple-grid">
      <div class="container">
        <div class="simple-grid-content grid-2">
          <div class="simple-grid-content-text">
            <h3 style="font-size: var(--big-font)">
              Get the Student Health Care Stress-Free With Study Canada
            </h3>
            <p class="mb-3">
              We've done the hard work of selecting quality health cover
              providers wherever you choose to study in Canada.
            </p>
            <h4 class="text-dark">Our quality providers offer:</h4>
    ...
    >
      <div class="container">
        <div class="sample-text-box">
          <h3 style="font-weight: var(--font-700)">
            Apply online for a quick turnaround
          </h3>
          <p>
            You can apply online and have a policy confirmation in just a few
            minutes or if you need a little extra help, ask an IDP counsellor to
            help organise your health cover with you. Once it's done, you can
            rest assured that you've made the best decision for your journey.
            You can move to the next job on your list!
          </p>
        </div>
        <div class="sample-text-box">
          <h3 style="font-weight: var(--font-700)">
          ...
          <p>
            Compare and choose the most relevant, affordable health cover or
            insurance for your needs. Our partners policies meet the strict
            conditions that registered health funds must comply to provide high
            quality cover for international students.
          </p>
        </div>
      </div>
    </div>
